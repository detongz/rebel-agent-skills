# Nad.fun LLM filenad.fun/llms.txt

Source: https://monad-foundation.notion.site/Nad-fun-LLM-file-0a203225b42041bc883124e26c053746?pvs=25
...
NadFun is a decentralized token launchpad on Monad. Tokens start on bonding curves where price increases as more people buy. When the curve reaches target reserves, tokens graduate to Uniswap V3 DEX.

- Network: Testnet (chain 10143) or Mainnet (chain 143)
- Language: TypeScript/JavaScript with viem
- Pure viem: No SDK required, direct contract calls
...
- [AUSD](https://nad.fun/ausd.md): LiFi swap (MON → aUSD) + Upshift vault yield
